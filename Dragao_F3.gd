...
const armadura_monstro = 9#--------------------------ARMADURA DO MONSTRO PARA PODER TOMAR HIT
...
#-----ATAQUE 1 MONSTRO----------------
const delay_ataque_1_aviso_1 = 0.1
const delay_ataque_1_pausa_1 = 0.1
const delay_ataque_1_aviso_2 = 0.1
const delay_ataque_1_pausa_2 = 0.1
const delay_ataque_1_hit_1 = 0.05
const dano_1_ataque_1 = 5
const delay_ataque_1_pausa_3 = 0.22
const delay_ataque_1_hit_2 = 0.05
const dano_2_ataque_1 = 6
const delay_ataque_1_pausa_4 = 0.22
const delay_ataque_1_hit_3 = 0.05
const dano_3_ataque_1 = 7
const delay_ataque_1_pausa_5 = 0.1


#-----ATAQUE 2 MONSTRO----------------
const delay_ataque_2_aviso_1 = 0.15
const delay_ataque_2_pausa_1 = 0.08
const delay_ataque_2_hit_1 = 0.05
const dano_1_ataque_2 = 7
const delay_ataque_2_pausa_2 = 0.22
const delay_ataque_2_hit_2 = 0.05
const dano_2_ataque_2 = 6
const delay_ataque_2_pausa_3 = 0.1


#-----ATAQUE 3 MONSTRO----------------
const delay_ataque_3_aviso_1 = 2
const delay_ataque_3_pausa_1 = 0.1
const delay_ataque_3_hit_1 = 0.15
const dano_1_ataque_3 = 25
const delay_ataque_3_pausa_2 = 0.5
...
func monstro_ataque_2():
	...
	#--------------------------------------------------------------------------------------
		...
		#--------------------------------------------------------------------------------------
			...
			if !monstro_vulneravel:
				$sprites_monstro.frame = 0
			yield(get_tree().create_timer(delay_ataque_2_pausa_3), "timeout")
		#------------------------------------TERMINA ATAQUE-------------------------------------------
			if !atacou_stand_by_timer.time_left:
				atacou_stand_by_timer.start()
			monstro_atacando = false
...
#-------------------------ATAQUE 3------------------------------------
func monstro_ataque_3():
	if !monstro_atacando:
		altera_timer(dano_1_ataque_3, delay_ataque_3_pausa_1, delay_ataque_3_hit_1)
		$Label.text = "Ataque 3 Padrao 1"
		monstro_atacando = true
		$sprites_monstro.frame = 2
		yield(get_tree().create_timer(delay_ataque_3_aviso_1), "timeout")#----VIRA 2 SEGUNDOS
		$sprites_monstro.frame = 1
	...
	#--------------------------------------------------------------------------------------
		...
		$Label.text = "Ataque 3 Pausa final"
		if !monstro_vulneravel:
			$sprites_monstro.frame = 0
		yield(get_tree().create_timer(delay_ataque_3_pausa_2), "timeout")
		if !atacou_stand_by_timer.time_left:
			atacou_stand_by_timer.start()
		monstro_atacando = false
		if monstro_vulneravel == false:
