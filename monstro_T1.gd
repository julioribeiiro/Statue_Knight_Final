...
#-----ATAQUE 1 MONSTRO----------------
const delay_ataque_1_aviso_1 = 0.3#-----TEMPO QUE O MONSTRO PASSA NO SPRITE AVISO 1
const delay_ataque_1_pausa_1 = 0.3#--------TEMPO QUE O MONSTRO PASSA NO SPRITE PAUSA 1
const delay_ataque_1_aviso_2 = 0.3#-----TEMPO QUE O MONSTRO PASSA NO SPRITE AVISO 2
const delay_ultimo_sprite = 0.3#------TEMPO NO ULTIMO SPRITE(SPRITE DE PAUSA)
