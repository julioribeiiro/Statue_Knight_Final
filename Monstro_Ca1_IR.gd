...
const monstro_hp = 1#--------------------------------QUANTIDADE DE HITS QUE MONSTRO DEVE RECEBER PARA MORRER
...
#-----ATAQUE 1 MONSTRO----------------
const delay_ataque_1_aviso_1 = 0.2
const delay_ataque_1_pausa_1 = 0.2
const delay_ataque_1_aviso_2 = 0.2
const delay_ataque_1_pausa_2 = 0.2
const delay_ataque_1_hit_1 = 0.3
const dano_1_ataque_1 = 8
const delay_ataque_1_pausa_3 = 0.1
const delay_ataque_1_hit_2 = 0.3
const dano_2_ataque_1 = 12
const delay_ataque_1_pausa_4 = 0.1


#-----ATAQUE 2 MONSTRO----------------
const delay_ataque_2_aviso_1 = 0.2
const delay_ataque_2_pausa_1 = 0.1
const delay_ataque_2_aviso_2 = 0.2
const delay_ataque_2_pausa_2 = 0.1
const delay_ataque_2_aviso_3 = 0.2
const delay_ataque_2_pausa_3 = 0.1
const delay_ataque_2_hit_1 = 0.3
const dano_1_ataque_2 = 6
const delay_ataque_2_pausa_4 = 0.05
const delay_ataque_2_hit_2 = 0.3
const dano_2_ataque_2 = 6
const delay_ataque_2_pausa_5 = 0.05
const delay_ataque_2_hit_3 = 0.3
const dano_3_ataque_2 = 6
const delay_ataque_2_pausa_6 = 0.1
...
func monstro_ataque_1():
	...
	#--------------------------------------------------------------------------------------
		...
		#--------------------------------------------------------------------------------------
			...
			if !monstro_vulneravel:
				$sprites_monstro.frame = 0
			yield(get_tree().create_timer(delay_ataque_1_pausa_4), "timeout")
		#------------------------------------TERMINA ATAQUE-------------------------------------------
...
func monstro_ataque_2():
	if !monstro_atacando:
		altera_timer(dano_1_ataque_2, delay_ataque_2_pausa_3, delay_ataque_2_hit_1)
		$Label.text = "Ataque 2 Padrao 1"
		monstro_atacando = true
		$sprites_monstro.frame = 6#----------FRAME DE AVISO VAI VIRAR 1 SEGUNDO
		$alertB.play()
		yield(get_tree().create_timer(delay_ataque_2_aviso_1), "timeout")#-------DELAY DE AVISO
		$sprites_monstro.frame = 1
		yield(get_tree().create_timer(delay_ataque_2_pausa_1), "timeout")
		$sprites_monstro.frame = 6#----------FRAME DE AVISO VAI VIRAR 1 SEGUNDO
		$alertB.play()
		yield(get_tree().create_timer(delay_ataque_2_aviso_2), "timeout")
		$sprites_monstro.frame = 1
		yield(get_tree().create_timer(delay_ataque_2_pausa_2), "timeout")
		$sprites_monstro.frame = 6
		$alertB.play()
		yield(get_tree().create_timer(delay_ataque_2_aviso_3), "timeout")
		$sprites_monstro.frame = 1
		timer_ate_hitar.start()#-------------COMECA O DELAY_ATAQUE_2_PAUSA_3
		yield(timer_ate_hitar, "timeout")
		$sprites_monstro.frame = 5
		perfect_parry_desativado = true
		yield(get_tree().create_timer(delay_tolerancia_defesa), "timeout")#------TEMPO DE TOLERANCIA PARA DEFESA
	...
	#--------------------------------------------------------------------------------------
		...
		#------COMECA OUTRO PADRAO-------------------------------------------------
			...
			altera_timer(dano_2_ataque_2, delay_ataque_2_pausa_4, delay_ataque_2_hit_2)
			$sprites_monstro.frame = 1#---------------FRAME DE PAUSA
			timer_ate_hitar.start()#-----------COMECA O DELAY_ATAQUE_2_PAUSA_4
			yield(timer_ate_hitar, "timeout")
			$sprites_monstro.frame = 5
			perfect_parry_desativado = true
		#------------ALTERAR ESTA PARTE QUANDO FOR ALTERAR PERFECT PARRY
		...
		#--------------------------------------------------------------------------------------
			...
			if !monstro_vulneravel:
			#------COMECA OUTRO PADRAO-------------------------------------------------
				$Label.text = "Ataque 2 Padrao 3"
				altera_timer(dano_3_ataque_2, delay_ataque_2_pausa_5, delay_ataque_2_hit_3)
				$sprites_monstro.frame = 1#---------------FRAME DE PAUSA
				timer_ate_hitar.start()#-----------COMECA O DELAY_ATAQUE_2_PAUSA_5
				yield(timer_ate_hitar, "timeout")
				$sprites_monstro.frame = 5
				perfect_parry_desativado = true
			#------------ALTERAR ESTA PARTE QUANDO FOR ALTERAR PERFECT PARRY
			...
			#--------------------------------------------------------------------------------------
				...
				if !monstro_vulneravel:
					$sprites_monstro.frame = 0
				yield(get_tree().create_timer(delay_ataque_2_pausa_6), "timeout")
