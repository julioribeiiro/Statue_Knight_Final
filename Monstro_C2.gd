...
const delay_ataque_2_pausa_1 = 0.2
const delay_ataque_2_hit_1 = 0.3
const dano_1_ataque_2 = 10
const delay_ataque_2_pausa_2 = 0.1

#-----ATAQUE 3 MONSTRO----------------
const delay_ataque_3_aviso_1 = 0.2#-----TEMPO QUE O MONSTRO PASSA NO SPRITE AVISO 1
const delay_ataque_3_pausa_1 = 0.1#--------TEMPO QUE O MONSTRO PASSA NO SPRITE PAUSA 1
const delay_ataque_3_aviso_2 = 0.2#-----TEMPO QUE O MONSTRO PASSA NO SPRITE AVISO 2
const delay_ataque_3_pausa_2 = 0.1#------TEMPO NO ULTIMO SPRITE(SPRITE DE PAUSA)
const delay_ataque_3_aviso_3 = 0.2
const delay_ataque_3_hit_1 = 0.3#----------------------TEMPO QUE O HITBOX DO ATAQUE FICA ATIVO
const dano_1_ataque_3 = 10
const delay_ataque_3_pausa_3 = 0.1
...
func monstro_ataque_3():
	if !monstro_atacando:
		dano = dano_1_ataque_3
		$Label.text = "Ataque 3"
		altera_timer(delay_ataque_3_aviso_3, delay_ataque_3_hit_1)
		monstro_atacando = true
		$sprites_monstro.frame = 6
		$alertB.play()
		yield(get_tree().create_timer(delay_ataque_3_aviso_1), "timeout")
		$sprites_monstro.frame = 2
		yield(get_tree().create_timer(delay_ataque_3_pausa_1), "timeout")
		$sprites_monstro.frame = 6
		$alertB.play()
		yield(get_tree().create_timer(delay_ataque_3_aviso_2), "timeout")
		$sprites_monstro.frame = 2
	...
	#-----------MINI DELAY DEPOIS DE KNIGHT DEFENDER O ATAQUE COM SUCESSO
		if knight_defendeu == true and !perfect_parry:
			...
			knight_defendeu = false
	#--------------------------------------------------------------------------------------
		yield(get_tree().create_timer(delay_ataque_3_pausa_3), "timeout")
		perfect_parry = false
		if !atacou_stand_by_timer.time_left:
			atacou_stand_by_timer.start()
		monstro_atacando = false
