...
const delay_ataque_2_pausa_3 = 0.05
...
func monstro_ataque_2():
	if !monstro_atacando:
		altera_timer(dano_1_ataque_2, delay_ataque_2_pausa_2, delay_ataque_2_hit_1)
		$Label.text = "Ataque 2 Padrao 1"
		monstro_atacando = true
		$sprites_monstro.frame = 3#----------FRAME DE AVISO VAI VIRAR 1 SEGUNDO
		$alertC.play()
	...
	#--------------------------------------------------------------------------------------
		...
		#------COMECA OUTRO PADRAO-------------------------------------------------
			...
			altera_timer(dano_2_ataque_2, delay_ataque_2_pausa_3, delay_ataque_2_hit_2)
			$sprites_monstro.frame = 1#---------------FRAME DE PAUSA
		...
		#--------------------------------------------------------------------------------------
			...
			#------COMECA OUTRO PADRAO-------------------------------------------------
				...
				altera_timer(dano_3_ataque_2, delay_ataque_2_pausa_4, delay_ataque_2_hit_3)
				$sprites_monstro.frame = 1#---------------FRAME DE PAUSA
				timer_ate_hitar.start()#-----------COMECA O DELAY_ATAQUE_2_PAUSA_3
				yield(timer_ate_hitar, "timeout")
				$sprites_monstro.frame = 5
			...
			#--------------------------------------------------------------------------------------
				...
				if !monstro_vulneravel:
					$sprites_monstro.frame = 0
				yield(get_tree().create_timer(delay_ataque_2_pausa_5), "timeout")
